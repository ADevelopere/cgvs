...
export function isTextVariableDifferent(
    ...
    if (isDifferent(temporary.preview_value, original.preview_value)) {
        console.log(
            "Preview value is different",
            "temporary",
            temporary.preview_value,
            "original",
            original.preview_value,
        );
        return true;
    }
    if (isDifferent(temporary.min_length, original.min_length)) {
        console.log(
            "Min length is different",
            "temporary",
            temporary.min_length,
            "original",
            original.min_length,
        );
        return true;
    ...
    if (isDifferent(temporary.max_length, original.max_length)) {
        console.log(
            "Max length is different",
            "temporary",
            temporary.max_length,
            "original",
            original.max_length,
        );
        return true;
