...
export const DemoTableProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  }, [usePagination, paginatorInfo, sortedAndFilteredDataset, filteredTotalRows, loadedRows])
