...
const SplitPane: FC<SplitPaneProps> = ({
  ...
  }, [firstPane.visible, secondPane.visible, firstPane.preferredRatio, secondPane.preferredRatio, lastActiveRatios]);
  ...
  const calculatePaneSizes = useCallback(() => {
    ...
    const normalizedFirstRatio = totalRatio === 0 ? 0 : firstRatio / totalRatio;
  ...
  }, [allowResize, active, onDragFinished, draggedSize, orientation, containerWidth, containerHeight, pane1Size, pane2Size]);
