...
import { type Theme, Experimental_CssVarsProvider as CssVarsProvider } from "@mui/material/styles" // Import CssVarsProvider
import { CssBaseline } from "@mui/material"
import { ltrLightTheme, rtlLightTheme, rtlDarkTheme, ltrDarkTheme } from "../theme"
...
export const AppThemeProvider: React.FC<AppThemeProviderProps> = ({ children }) => {
  ...
  const [currentLanguage, setCurrentLanguage] = useState<AppLanguage>(getStoredLanguage() as AppLanguage)
