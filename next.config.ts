            ...
            value:
              process.env.NODE_ENV === "production"
                ...
                : [
                    ...
                    "connect-src 'self' http://localhost:* ws://localhost:* wss://localhost:* https://*.apollographql.com https://*.googletagmanager.com https://*.amplitude.com https://sentry.io https://storage.googleapis.com",
