...
CREATE TYPE "public"."certificate_field" AS ENUM('VERIFICATION_CODE', 'RELEASE_DATE');--> statement-breakpoint
CREATE TYPE "public"."data_source_type" AS ENUM('STATIC', 'TEMPLATE_VARIABLE', 'STUDENT_FIELD', 'CERTIFICATE_FIELD');--> statement-breakpoint
CREATE TYPE "public"."element_alignment" AS ENUM('LEFT', 'CENTER', 'RIGHT', 'TOP', 'MIDDLE', 'BOTTOM');--> statement-breakpoint
...
CREATE TYPE "public"."element_type" AS ENUM('TEXT', 'IMAGE', 'DATE', 'GENDER', 'NATIONALITY', 'COUNTRY', 'QR_CODE', 'NUMBER_VARIABLE');--> statement-breakpoint
CREATE TYPE "public"."font_source" AS ENUM('GOOGLE', 'UPLOADED');--> statement-breakpoint
CREATE TYPE "public"."student_field" AS ENUM('STUDENT_NAME', 'STUDENT_EMAIL', 'DATE_OF_BIRTH', 'GENDER', 'NATIONALITY');--> statement-breakpoint
CREATE TABLE "cache" (
...
--> statement-breakpoint
CREATE TABLE "element_qr_code" (
	"id" integer PRIMARY KEY NOT NULL,
	"data_source_type" "data_source_type" NOT NULL,
	"static_data" text,
...
--> statement-breakpoint
CREATE TABLE "element_number_variable" (
	"id" integer PRIMARY KEY NOT NULL,
	"text_props_id" integer NOT NULL,
	"template_variable_id" integer NOT NULL,
	"mapping" jsonb NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
);
--> statement-breakpoint
CREATE TABLE "element_gender" (
	"id" integer PRIMARY KEY NOT NULL,
	"text_props_id" integer NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
...
--> statement-breakpoint
CREATE TABLE "element_nationality" (
	"id" integer PRIMARY KEY NOT NULL,
	"text_props_id" integer NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
