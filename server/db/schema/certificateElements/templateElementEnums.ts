...
// Element Types
export const elementTypeEnum = createPgEnumFromEnum("element_type", ElementTypes.ElementType);

// Element Layout & Styling
export const elementAlignmentEnum = createPgEnumFromEnum("element_alignment", ElementTypes.ElementAlignment);

export const elementOverflowEnum = createPgEnumFromEnum("element_overflow", ElementTypes.ElementOverflow);

export const elementImageFitEnum = createPgEnumFromEnum("element_image_fit", ElementTypes.ElementImageFit);

// Text Data Source Configuration
export const textDataSourceTypeEnum = createPgEnumFromEnum("text_data_source_type", ElementTypes.TextDataSourceType);

export const studentTextFieldEnum = createPgEnumFromEnum("student_text_field", ElementTypes.StudentTextField);
...
export const dateDataSourceTypeEnum = createPgEnumFromEnum("date_data_source_type", ElementTypes.DateDataSourceType);

export const studentDateFieldEnum = createPgEnumFromEnum("student_date_field", ElementTypes.StudentDateField);
...
// Date Configuration
export const calendarTypeEnum = createPgEnumFromEnum("calendar_type", ElementTypes.CalendarType);
