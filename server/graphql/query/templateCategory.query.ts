...
gqlSchemaBuilder.queryFields((t) => ({
    templateCategory: t.field({
        ...
        resolve: async (_query, args) =>
            TemplateCategoryRepository.findById(args.id),
    }),
    ...
    mainTemplateCategory: t.field({
        type: TemplateCategoryPothosObject,
        resolve: async () =>
            TemplateCategoryRepository.findTemplatesMainCategory(),
    }),

    suspensionTemplateCategory: t.field({
        type: TemplateCategoryPothosObject,
        resolve: async () =>
            TemplateCategoryRepository.findTemplatesSuspensionCategory(),
    }),
}));
