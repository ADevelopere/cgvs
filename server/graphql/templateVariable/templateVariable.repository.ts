...
export const createTemplateTextVariable = async (
...
export const createTemplateNumberVariable = async (
...
export const createTemplateDateVariable = async (
...
export const createTemplateSelectVariable = async (
...
export const updateTemplateTextVariable = async (
...
export const updateTemplateNumberVariable = async (
...
export const updateTemplateDateVariable = async (
...
export const updateTemplateSelectVariable = async (
...
export const findTemplateVariableById = async (
    id: number,
...
export const findTemplateVariablesByTemplateId = async (
    templateId: number,
...
export const loadTemplateVariablesForTemplates = async (
    templateIds: number[],
): Promise<TmvTypes.TemplateVariablePothosUnion[][]> => {
    if (templateIds.length === 0) return [];
    const allVars = await Promise.all(
        templateIds.map((id) => findTemplateVariablesByTemplateId(id)),
    );
    return allVars;
};

export const deleteTemplateVariableById = async (
    id: number,
): Promise<TmvTypes.TemplateVariablePothosDefinition> => {
    const baseVar = await findTemplateBaseVariableById(id);
    if (!baseVar) {
