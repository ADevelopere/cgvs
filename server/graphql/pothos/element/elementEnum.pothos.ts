...
export const ElementAlignmentPothosEnum = gqlSchemaBuilder.enumType("ElementAlignment", {
  values: Object.values(Types.ElementAlignment),
});

export const ElementOverflowPothosEnum = gqlSchemaBuilder.enumType("ElementOverflow", {
