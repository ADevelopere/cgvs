...
export const recipient: RecipientTranslation = {
  ...
  recipientsDeleted: "تم حذف المستلمين بنجاح",
  addedToGroup: "تمت إضافة الطلاب إلى المجموعة بنجاح",
  removedFromGroup: "تم حذف الطلاب من المجموعة بنجاح",

  // Error messages
  errorFetchingRecipient: "فشل في جلب المستلم",
  errorFetchingRecipients: "فشل في جلب المستلمين",
  errorCreatingRecipient: "فشل في إنشاء المستلم",
  errorDeletingRecipient: "فشل في حذف المستلم",
