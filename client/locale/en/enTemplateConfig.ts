import { TemplateConfigTranslations } from "../components";

export const enTemplateConfig: TemplateConfigTranslations = {
  // Form Labels
  width: "Width",
  height: "Height",
  ...
  // Error Messages
  failedToCreateTemplateConfiguration:
    "Failed to create template configuration.",
  failedToUpdateTemplateConfiguration:
  ...
  valueMustBeLessThanOrEqualTo10000:
    "Value must be less than or equal to 10000",
  valueIsTooSmall: "Value is too small",
