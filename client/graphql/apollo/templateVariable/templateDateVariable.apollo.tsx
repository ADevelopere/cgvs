...
export const TemplateDateVariableGraphQLProvider: React.FC<{
 ...
 const [mutateCreate] = useMutation(
  Document.createTemplateDateVariableMutationDocument,
  {
   update(cache, { data }) {
    ...
    const createdVar = data.createTemplateDateVariable;
 ...
 const [mutateUpdate] = useMutation(
  Document.updateTemplateDateVariableMutationDocument,
  {
   update(cache, { data }) {
    ...
    const updatedVar = data.updateTemplateDateVariable;
 ...
 const contextValue = useMemo(
  ...
  [createTemplateDateVariableMutation, updateTemplateDateVariableMutation],
 );
