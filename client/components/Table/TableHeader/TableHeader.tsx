  ...
  return (
    <>
        ...
        {visibleColumns.map(column => {
          ...
          return (
            <ColumnHeaderCell
              ...
              onTextFilterIconClick={getFilterIconClickHandler(column) ?? noop}
      ...
      <ColumnOptionsMenu
        ...
        columnLabel={
          visibleColumns.find(col => col.id === activeOptionsColumn)?.label ||
          ""
        }
      ...
      <FilterPopover
        ...
        columnLabel={
          visibleColumns.find(col => col.id === activeFilterColumn)?.label ?? ""
        }
        value={
          activeFilterColumn ? (tempFilterValues[activeFilterColumn] ?? "") : ""
        }
        hasActiveFilter={!!activeFilterColumn && !!filters[activeFilterColumn]}
      ...
      {activeNumberFilterColumn && (
        <NumberFilterPopover
          ...
          columnLabel={
            visibleColumns.find(col => col.id === activeNumberFilterColumn)
              ?.label || ""
          }
