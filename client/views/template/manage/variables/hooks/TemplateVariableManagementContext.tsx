...
export const TemplateVariableManagementProvider: React.FC<{
  ...
  const handleCreateTemplateTextVariable = useCallback(
    async (
      ...
      setLoading(true);
      try {
        const result = await variableService.createTextVariable(
          variables.input,
        );
        return !!result;
      } finally {
  ...
  const handleUpdateTemplateTextVariable = useCallback(
    async (
      ...
      setLoading(true);
      try {
        const result = await variableService.updateTextVariable(
          variables.input,
        );
        return !!result;
      } finally {
  ...
  const handleCreateTemplateNumberVariable = useCallback(
    async (
      ...
      setLoading(true);
      try {
        const result = await variableService.createNumberVariable(
          variables.input,
        );
        return !!result;
      } finally {
  ...
  const handleUpdateTemplateNumberVariable = useCallback(
    async (
      ...
      setLoading(true);
      try {
        const result = await variableService.updateNumberVariable(
          variables.input,
        );
        return !!result;
      } finally {
  ...
  const handleCreateTemplateDateVariable = useCallback(
    async (
      ...
      setLoading(true);
      try {
        const result = await variableService.createDateVariable(
          variables.input,
        );
        return !!result;
      } finally {
  ...
  const handleUpdateTemplateDateVariable = useCallback(
    async (
      ...
      setLoading(true);
      try {
        const result = await variableService.updateDateVariable(
          variables.input,
        );
        return !!result;
      } finally {
  ...
  const handleCreateTemplateSelectVariable = useCallback(
    async (
      ...
      setLoading(true);
      try {
        const result = await variableService.createSelectVariable(
          variables.input,
        );
        return !!result;
      } finally {
  ...
  const handleUpdateTemplateSelectVariable = useCallback(
    async (
      ...
      setLoading(true);
      try {
        const result = await variableService.updateSelectVariable(
          variables.input,
        );
        return !!result;
      } finally {
