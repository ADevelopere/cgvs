      ...
      optimisticResponse: variables => {
        ...
        return {
          ...
          updateNumberElement: {
            ...
            numberDataSource: {
              ...existingElement.numberDataSource,
              ...input.dataSource, // Merge new 'dataSource' fields
            },
            numberProps: {
              ...existingElement.numberProps,
              ...input.numberProps, // Merge new 'numberProps' fields
              variableId: input.dataSource.variableId,
            },
          },
        };
      },
