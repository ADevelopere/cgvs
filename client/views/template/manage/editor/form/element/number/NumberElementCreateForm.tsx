...
interface NumberElementCreateFormProps {
  state: NumberElementFormCreateState;
...
export const NumberElementCreateForm: FC<NumberElementCreateFormProps> = ({
  state,
  errors,
  updateBaseElement,
  updateTextProps,
