...
interface DateElementUpdateFormProps {
  state: DateElementFormUpdateState;
...
export const DateElementUpdateForm: FC<DateElementUpdateFormProps> = ({
  state,
  errors,
  updateBaseElement,
  updateTextProps,
