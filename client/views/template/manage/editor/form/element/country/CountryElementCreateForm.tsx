...
import type { CountryElementFormErrors, CountryElementFormCreateState } from "./types";
...
interface CountryElementCreateFormProps {
  state: CountryElementFormCreateState;
...
export const CountryElementCreateForm: FC<CountryElementCreateFormProps> = ({
  state,
  errors,
  updateBaseElement,
  updateTextProps,
