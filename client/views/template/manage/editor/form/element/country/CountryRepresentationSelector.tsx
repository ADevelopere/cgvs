...
export const CountryRepresentationSelector: FC<CountryRepresentationSelectorProps> = ({
  value,
  onChange,
  error,
  disabled = false,
  ...
  return (
    <Box>
      <FormControl component="fieldset" error={!!error} disabled={disabled} fullWidth>
        <FormLabel component="legend">{strings.countryElement.representationLabel}</FormLabel>
        <RadioGroup value={value} onChange={e => onChange(e.target.value as CountryRepresentation)}>
          <FormControlLabel
            value={CountryRepresentation.CountryName}
            control={<Radio />}
            label={
              <Box>
                <Typography variant="body1">{strings.countryElement.representationCountryName}</Typography>
          ...
          <FormControlLabel
            ...
            label={
              <Box>
                <Typography variant="body1">{strings.countryElement.representationNationality}</Typography>
                <Typography variant="caption" color="text.secondary">
