...
export interface ImageElementUpdateFormProps {
  element: ImageElement;
  onSubmit: (input: ImageElementUpdateInput) => void | Promise<void>;
  onCancel: () => void;
  loading?: boolean;
}

export const ImageElementUpdateForm: React.FC<ImageElementUpdateFormProps> = ({
  element,
  onSubmit,
  onCancel,
  loading = false,
  ...
  // Initialize form state from element
  const [formState, setFormState] = useState<ImageElementFormUpdateState>(() =>
    imageElementToFormState(element)
  );
  ...
  // Update form state when element changes
  useEffect(() => {
    setFormState(imageElementToFormState(element));
  }, [element]);
  ...
  const handleSubmit = async () => {
    ...
    const input: ImageElementUpdateInput = {
      ...formState.base,
