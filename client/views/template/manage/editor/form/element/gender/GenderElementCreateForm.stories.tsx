...
import { GenderElementCreateForm } from "./GenderElementCreateForm";
import type {
  GenderElementFormCreateState,
  GenderElementFormErrors,
} from "./types";

const meta: Meta<typeof GenderElementCreateForm> = {
  title: "Template/Editor/Form/Element/Gender/GenderElementCreateForm",
  component: GenderElementCreateForm,
  tags: ["autodocs"],
};

export default meta;
type Story = StoryObj<typeof GenderElementCreateForm>;

const mockState: GenderElementFormCreateState = {
  base: {
    templateId: 1,
    name: "Student Gender",
